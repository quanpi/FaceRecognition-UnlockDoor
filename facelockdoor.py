...
d=0
while q<=2:
    data_path = 'C:/Users/plqua/Desktop/facerecog/face-unlock-door/code/dataset/quan-pl/'
    ...
    q+=1
face_classifier = cv2.CascadeClassifier('C:/Users/plqua/Desktop/facerecog/face-unlock-door/code/haarcascade_frontalface_default.xml')
...
while True:
    ...
    try:
        ...
        d+=1
        pass   
    if cv2.waitKey(1)==13 or x==10 or c==50 or d==50:
        break
cap.release()
...
if x>=10:
    ...
    var = 'a'
    c=var.encode()
    speak("Hello mr.Quan...welcome..sir...Door is openning for 5 seconds")
    ard.write(c)
    time.sleep(4)
elif c==30:
